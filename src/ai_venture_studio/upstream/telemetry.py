...
track the actions the success metrics name. `avs digest` turns
...
(`avs digest`) reads them; nothing leaves the machine.
"""
import json
import os
import time
...
_TELEMETRY_JS = """// avs telemetry (小程序) — 本地事件记录，不出设备
