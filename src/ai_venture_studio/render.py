...
from ai_venture_studio.state import LeaderResult, VoterOutput
...
def render_pr_comment(
    ...
    *,
    ...
    lines = [
        f"## avs review — **{result.verdict.value}**",
        "",
        result.summary,
        "",
    ]
    ...
    lines += [
        ...
        "finding(s) dropped by filter/dedupe/merge · ai-venture-studio</sub>",
    ]
    return "\n".join(lines)
