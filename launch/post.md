...
behavioral probes ([benchmark](https://github.com/melodygaoyifan/ai-product-autopilot/blob/main/docs/benchmark.md)).
...
([one real run](https://github.com/melodygaoyifan/ai-product-autopilot#a-real-run-unedited)).
...
67% on 13 labeled cases, against bars of 40% and 50% ([reproduce it](https://github.com/melodygaoyifan/ai-product-autopilot/blob/main/docs/benchmark.md)).
...
([the transcript](https://github.com/melodygaoyifan/ai-product-autopilot#a-real-run-unedited)).
...
Three doors: [solo founders](https://github.com/melodygaoyifan/ai-product-autopilot/blob/main/editions/solo/START-HERE.md),
[enterprise](https://github.com/melodygaoyifan/ai-product-autopilot/blob/main/editions/enterprise/START-HERE.md),
[engineers](https://github.com/melodygaoyifan/ai-product-autopilot/blob/main/editions/engineer/START-HERE.md).
